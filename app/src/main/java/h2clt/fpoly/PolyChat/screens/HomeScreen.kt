        ...
        Column(
            ...
            Row(
                modifier = Modifier
                    .width(130.dp)
                    .height(30.dp)
                    .background(Color(0xFFEB194E), shape = RoundedCornerShape(16.dp))
                    .clickable {}
                ,
                horizontalArrangement = Arrangement.Center,
                verticalAlignment = Alignment.CenterVertically
                ...
                Text(
                    ...
                    color = Color.White,
                    fontSize = 15.sp,
                    modifier = Modifier.width(90.dp), // Cho phép Text tràn nội dung trong nút
                    maxLines = 1, // Giới hạn số dòng là 1 để đảm bảo chỉ hiển thị trên một hàng
                    overflow = TextOverflow.Ellipsis // Xử lý trường hợp vượt quá kích thước bằng việc hiển thị "..." ở cuối
                )
            }
        }
